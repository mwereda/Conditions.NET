...
namespace Conditions
{
    public static class NumericExtensions
    {
        ...
        {
            return ConditionResult<T>.Create(value.CompareTo(givenValue).Equals(Greater));
        }
        ...
        public static ConditionResult<T> IsGreaterOrEqual<T>(this T value, T givenValue) where T : struct, IComparable<T>
        {
            ...
            return ConditionResult<T>.Create(result);
        }
        ...
        {
            return ConditionResult<T>.Create(value.CompareTo(givenValue).Equals(Lower));
        }
        ...
        {
            return ConditionResult<T>.Create(value.CompareTo(default(T)).Equals(Greater));
        }
        ...
        {
            return ConditionResult<T>.Create(value.CompareTo(default(T)).Equals(Lower));
        }
    }
}
